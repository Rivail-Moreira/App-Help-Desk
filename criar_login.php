            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <form action="./controller/incluirLogin.php" method="get">
                    <div class="form-group">
                      <label>Nome</label>
                      <input type="text" name="txtnome" class="form-control" placeholder="Título">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Senha</label>
                      <input type="password" name="txtpassword" class="form-control" placeholder="senha">
                    </div>
