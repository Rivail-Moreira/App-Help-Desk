...
$sql = "INSERT INTO tb_usuario (nome_usuario,email_usuario,senha_usuario,id_perfil,id_categoria) 
VALUES ('','$nome', '$email', '$senha',$perfil,1);";
/*$sql = "INSERT INTO tb_usuario(nome_usuario, email_usuario, senha_usuario, id_perfil) VALUES ('$nome','$email','$senha ','$perfil');";*/
